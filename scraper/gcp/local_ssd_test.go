...
// series except Z3's 3,000 GiB Titanium SSD disks), with the disk count in
// the human-readable description as a fallback. Shapes without bundled Local
// SSD must report 0 so attachable-SSD families keep local_ssd=false.
